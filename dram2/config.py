...
glimpse_arg.add_argument(
    "--patch_size", type=int, default=12, help="size of extracted patch at highest res"
)
glimpse_arg.add_argument(
    "--glimpse_scale", type=int, default=1, help="scale of successive patches"
)
glimpse_arg.add_argument(
    "--num_patches", type=int, default=2, help="# of downscaled patches per glimpse"
)
glimpse_arg.add_argument(
...
core_arg.add_argument(
    "--num_glimpses", type=int, default=18, help="# of glimpses, i.e. BPTT iterations"
)
core_arg.add_argument("--hidden_size", type=int, default=256, help="hidden size of rnn")
core_arg.add_argument("--is_lstm", type=bool, default=True, help="hidden size of rnn")
core_arg.add_argument("--num_layers", type=int, default=2, help="the number of layers of rnn")
core_arg.add_argument("--is_covnet", type=bool, default=True, help="the number of layers of rnn")

# reinforce params
reinforce_arg = add_argument_group("Reinforce Params")
reinforce_arg.add_argument(
    "--std", type=float, default=0.15, help="gaussian policy standard deviation"
)
reinforce_arg.add_argument(
    "--M", type=int, default=3, help="Monte Carlo sampling for valid and test sets"
)
reinforce_arg.add_argument(
    "--discount", type=float, default=0.99, help="discount reward"
)
...
data_arg.add_argument("--im_size", type=int, default=28, help="croped image size")
