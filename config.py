...
core_arg.add_argument("--num_layers", type=int, default=1, help="the number of layers of rnn")
core_arg.add_argument("--is_context", type=bool, default=False, help="hidden size of rnn")
...
train_arg.add_argument(
    "--epochs", type=int, default=250, help="# of epochs to train for"
)
train_arg.add_argument(
